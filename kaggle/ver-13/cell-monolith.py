...
print('[ver13] Phase I adjEJ: P1 diverge=0.5 revert + orphan=0 | P2 vel=0.25 | P3 leaf-prune>=0.3 | P4 divwide 11.0/16.0/12.0 + DC=0.15 | base v12.1 knockout: READMIT/GAPFILL/LOWDET off, reparent EP=0.4 (no-op), SEF_TTA 0.75, validator OFF')
...
_EXPECTED_NUMERIC = {'BIOHUB_DET_THRESHOLD': 0.965, 'BIOHUB_ILP_APPEARANCE_WEIGHT': 0.0, 'BIOHUB_ILP_DISAPPEARANCE_WEIGHT': 2, 'BIOHUB_GAP_CLOSE_UM': 5.0, 'BIOHUB_OUTPUT_MIN_TRACK_LEN': 6.0, 'BIOHUB_SAFE_DIV_MAX_UM': 11.0, 'BIOHUB_DEEPCENTER_SAFE_DIV_THRESHOLD': 0.15, 'BIOHUB_BIDIRECTIONAL_EDGE_WEIGHT': 0.15, 'BIOHUB_SECONDARY_EDGE_FEATURE_TTA_WEIGHT': 0.75, 'BIOHUB_MOTION_RELINK_VELOCITY_WEIGHT': 0.25, 'BIOHUB_LEAF_PRUNE_MIN_EDGE_PROB': 0.3, 'BIOHUB_SAFE_DIV_SISTER_MAX_UM': 16.0, 'BIOHUB_SAFE_DIV_EXISTING_CHILD_MAX_UM': 12.0}
...
EXPERIMENT_TAG = 'secondary_deepcenter_tta_0947_reparent_hoct_v13_p1rev_p2vel025_p3leaf030_p4divwide'
...
# [ver13] ==== P3 LEAF-PRUNE — port nguyên văn amanatar v4 (cell 5 dòng 1365-1421,
