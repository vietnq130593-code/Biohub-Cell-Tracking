...
EXPERIMENT_TAG = 'secondary_deepcenter_tta_0947_reparent_hoct_v131_sr0gc3_nodiv_gap3'
...
print('Verified progression preserved: 0.933 -> 0.934 -> 0.939 -> 0.941 -> 0.946 -> 0.947 -> ver-8 reparent -> ver-10 hoct-veto mode1 -> ver-11 mutual_nn-off + MIN_PDIV floor -> ver-12 4-truc portfolio (reparent+orphan+readmit+gapfill) -> ver-13.1 adjEJ-autopsy (SR0 divisions OFF + GC3 gap-close 3.0 + P1 revert + leaf-prune hygiene)')