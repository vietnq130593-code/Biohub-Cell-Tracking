# ver 7b · monolith — ver-7 (port notebook public LB 0.947 của Reyhan Ksatria) + Phase C:
# division ranker divnet (RANK-ONLY, W=15µm) + nới gate có kiểm soát (tau 0.6→1.2, diverge 2.25→1.0).
# Cơ sở: VER7-PLAN §Phase C + tích hợp chuẩn của tác giả divnet (RANK-ONLY mode) + megayak gate-audit.
# Mọi thay đổi so với ver-7 được đánh dấu [ver7b].
...
os.environ['BIOHUB_SAFE_DIV_SISTER_SYMMETRY_TAU'] = '1.2'
os.environ['BIOHUB_SAFE_DIV_DIVERGE_UM'] = '1.0'
...
EXPERIMENT_TAG = 'secondary_deepcenter_tta_0947_divnet_rank_v7b'
